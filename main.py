        ...
        channel_chats[channel_id] = gemini_client.chats.create(
            ...
            config={
                "system_instruction": (
                    ...
                    "You have conversation memory and are expected to remember personal details "
                    "that users explicitly share with you in chat (such as their name, preferences, or previous questions). "
                    "When asked what someone's name is, refer back to what they told you earlier in the chat history."
                )
            }
        )
